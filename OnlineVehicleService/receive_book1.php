...
$database="vkv_db";
				...
				if($isUserExists){
					...
					$resp=mysql_query("insert into register_tb values('$username','$password','$mopeds','$date','$time')") or die(mysql_error());
					if($resp)
					{
					if(session_id()==''){
						session_start();
				...
				$result=mysql_query("select vehicle_name from vehicle where vehicle_name='".$mopeds."'");
